...
class UserPreferences {
    constructor() {
        ...
        this.addPreference("higestResolutionImages", "higestResolutionImagesCheckboxInput", false);
        ...
        this.addPreference("removeAuthorNotes", "removeAuthorNotesCheckbox", true);
        this.addPreference("removeOriginal", "removeOriginalCheckbox", true);
        this.addPreference("maxPagesToFetchSimultaneously", "maxPagesToFetchSimultaneouslyTag", "4");
        ...
        this.addPreference("skipImages", "skipImagesCheckbox", true);
        this.addPreference("overwriteExistingEpub", "overwriteEpubWhenDuplicateFilenameCheckbox", true);
